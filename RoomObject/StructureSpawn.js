...
StructureSpawn.prototype.getBodyParts = function(budget, base, dlc) {
    ...
    */
    ...
    // MONKEY PATCH
    dlcCount = dlcCount < 0 ? 0 : dlcCount > 49 ? 49 : ~~dlcCount;
    //console.log(dlcCount);
    while (dlcCount--) {
        dlcParts.push.apply(dlcParts, dlc);
    }
    let nonCombatParts = _.remove(dlcParts, p => p === "tough" || p === "carry" || p === "work");
    return nonCombatParts.concat(dlcParts).concat(base); // Move all TOUGH to front
    /*
    var first = {};
